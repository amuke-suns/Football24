...
class _StandingsScreenState extends State<StandingsScreen> {
  ...
  Future<APIStandingsQuery> getStandingsData() async {
    ...
    return APIStandingsQuery.fromJson(jsonDecode(jsonString));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<APIStandingsQuery>(
  ...
  Widget _buildMainBody(AppDateManager dateManager, APILeague league) {
